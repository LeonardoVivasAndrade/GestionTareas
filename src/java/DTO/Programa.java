...
@NamedQueries({
    ...
    , @NamedQuery(name = "Programa.findBySemestre", query = "SELECT p FROM Programa p WHERE p.semestre = :semestre")})
public class Programa implements Serializable {
    ...
    public Programa(Integer idPrograma, String nombre, int semestre) {
        this.idPrograma = idPrograma;
        this.nombre = nombre;
    ...
    public String toString() {
        return "DTO.Programa[ idPrograma=" + idPrograma + " ]";
    }
